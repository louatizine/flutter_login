...
const String tDashboardHeading = "Ronaldo";
const String tDashboardSearch = "Zine";
const String tDashboardBannerTitle1 = "Zine";
const String tDashboardBannerTitle2 = "10 Lesson";
const String tDashboardBannerSubTitle = "View All";
const String tDashboardTopCourses = "hello";
const String tDashboardButton = "zine_eddine_Louati ";